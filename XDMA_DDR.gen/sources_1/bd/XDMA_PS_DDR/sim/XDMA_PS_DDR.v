...
//Date        : Fri Sep 19 12:57:03 2025
//Host        : awies-desktop running 64-bit major release  (build 9200)
//Command     : generate_target XDMA_PS_DDR.bd
//Design      : XDMA_PS_DDR
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "XDMA_PS_DDR,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=XDMA_PS_DDR,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=2,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_board_cnt=4,da_clkrst_cnt=6,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "XDMA_PS_DDR.hwdef" *) 
module XDMA_PS_DDR
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  XDMA_PS_DDR_axi_interconnect_0_0 axi_interconnect_0
  ...
  XDMA_PS_DDR_processing_system7_0_0 processing_system7_0
  ...
  XDMA_PS_DDR_rst_ps7_0_50M_0 rst_ps7_0_50M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
...
module XDMA_PS_DDR_axi_interconnect_0_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  s00_couplers_imp_155HXD5 s00_couplers
...
module s00_couplers_imp_155HXD5
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
  ...
  wire [3:0]auto_cc_to_auto_pc_ARID;
  ...
  wire [3:0]auto_cc_to_auto_pc_AWID;
  ...
  wire [3:0]auto_cc_to_auto_pc_BID;
  ...
  wire [3:0]auto_cc_to_auto_pc_RID;
